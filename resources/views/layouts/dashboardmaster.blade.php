                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            ...
                            <a href="{{ route('index') }}" class="btn btn-info btn-sm ml-5">Visit website</a>
                        </div>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{ url('team') }}" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-381-settings-2"></i>
				...
				<div class="copyright">
					<p><strong>Moon E-commerce</strong> © {{ \Carbon\Carbon::now()->format('Y') }} All Rights Reserved</p>
